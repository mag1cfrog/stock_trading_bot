...
class DashBackend(VisualizationBackendProtocol):
    ...
    def _extract_data(self, data_snapshot: List[Dict]) -> Tuple[List[str], List[float], List[float]]:
        """
    ...
    def _create_plotly_figure(self, timestamps: List[str], bid_prices: List[float], ask_prices: List[float]) -> go.Figure:
        """
